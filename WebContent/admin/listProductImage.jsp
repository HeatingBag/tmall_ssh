...
<li><a href="admin_product_list?category.id=${category.id}">${product.category.name}</a></li>
...
<td>${pi.id}</td>
<td>
<a title="点击产看原图" href="img/productSingle/${pi.id}.jpg"><img height="50px" src="img/productSingle/${pi.id}.jpg"></a>
</td>
<td><a deleteLink="true" href="admin_productImage_delete?productImage.id=${pi.id}"><span class="glyphicon glyphicon-trash"></span></a></td>
</tr>
</c:forEach>
</tbody>
</table>
...
<td>${pi.id}</td>
<td>
<a title="点击产看原图" href="img/productDetail/${pi.id}.jpg"><img height="50px" src="img/productDetail/${pi.id}.jpg"></a>
</td>
<td><a deleteLink="true" href="admin_productImage_delete?productImage.id=${pi.id}"><span class="glyphicon glyphicon-trash"></span></a></td>
</tr>
</c:forEach>
