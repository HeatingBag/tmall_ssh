<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	￥<fmt:formatNumber type="number" value="${product.originalPrice}" minFractionDigits="2"/></span> 元 </td>
	</tr>
	<tr>
	<td>配送：</td>
	<td>快递：0.00</td>
	...
	<div class="reviewStasticsLeftContent">累计评价 <span class="reviewStasticsNumber"> ${product.reviewCount}</span>
	</div>
	...
	<div class="reviewUserInfo pull-right">${r.user.anonymousName}<span class="reviewUserInfoAnonymous">(匿名)
	</span></div>
	</div>
	</c:forEach>
	</div>
