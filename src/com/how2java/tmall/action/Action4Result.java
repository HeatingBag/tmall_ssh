/**
* @author 作者 E-mail:
* @version 创建时间：2022年5月29日 下午5:04:09
*/
...
/**
 * 新增加Result：listCategoryPage， 用于客户端跳转到页面admin_category_list.
 * name = "listCategoryPage"于下面add()方法的return "listCategoryPage"对应
 * */

/*Action4Result 专门进行返回页面的定义*/
